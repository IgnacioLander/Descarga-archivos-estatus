...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_placeholder("Escribe aquí para buscar...").fill("marcas de cosm")
    page.get_by_role("link", name="Buscar").click()
    page.get_by_role("link", name="Programa Marcas de Cosméticos | Venezuela - Escuela Comercial").click()
    time.sleep(3)
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "Marcas_VE")
