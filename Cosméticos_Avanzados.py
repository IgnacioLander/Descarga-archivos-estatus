...
def run(playwright: Playwright) -> None:
    ...
    time.sleep(5)
    page.get_by_placeholder("Escribe aquí para buscar...").fill("cosm")
    page.get_by_role("link", name="Buscar").click()
    page.get_by_role("link", name="Programa de Cosméticos").click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "Cosméticos Avanzados")
