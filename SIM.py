...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_placeholder("Escribe aquí para buscar...").fill("SIM")
    page.get_by_role("link", name="Buscar").click()
    page.locator("div").filter(has_text=re.compile(r"^Curso básico de SIM$")).click()
    ...
    page.locator("input[name=\"UserStatus\"]").uncheck()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "SIM")
