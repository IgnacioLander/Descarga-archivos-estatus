...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_placeholder("Escribe aquí para buscar...").fill("dermocosméticos")
    time.sleep(3)
    page.get_by_role("link", name="Buscar").click()
    page.locator("div").filter(has_text=re.compile(r"^Programa Dermocosméticos \| Escuela Comercial$")).dblclick()
    time.sleep(1)
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "DERMO")
