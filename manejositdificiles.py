...
def run(playwright: Playwright) -> None:
    ...
    time.sleep(5)
    page.get_by_placeholder("Escribe aquí para buscar...").fill("Curso Manejo de Situaciones Difíciles en Tienda")
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "curso situaciones dificiles")
