...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("link", name="Programa 5 Conductas de Servicio | CAT- Call Center").dblclick()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "conductas call center")
