...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("link", name="Programa Servicios Farmacéuticos | Colombia - Escuela Comercial").click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "SF_Co")
