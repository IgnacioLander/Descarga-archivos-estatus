...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_placeholder("Escribe aquí para buscar...").fill("Medicinas ")
    page.get_by_role("link", name="Buscar").click()
    page.get_by_role("link", name="Programa Medicinas de OTC |").click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "Medicinas OTC")
