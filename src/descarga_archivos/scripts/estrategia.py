...
def run(playwright: Playwright) -> None:
    ...
    time.sleep(3)
    page.get_by_placeholder("Escribe aquí para buscar...").fill("estrategia comercial")
    page.get_by_role("link", name="Buscar").click()
    page.get_by_role("link", name="Programa Estrategia Comercial | Escuela Comercial").click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "estrategia")
