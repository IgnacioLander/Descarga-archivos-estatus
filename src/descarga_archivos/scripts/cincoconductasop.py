...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_placeholder("Escribe aquí para buscar...").fill("cinco conductas")
    page.get_by_placeholder("Escribe aquí para buscar...").press("Enter")
    page.locator("#ctl00_TopMenuControl_TopMenuDesktopControl1_adminOrTeacherSearch").click()
    page.get_by_placeholder("Escribe aquí para buscar...").fill("5 conductas")
    page.get_by_role("link", name="Buscar").click()
    page.get_by_role("link", name="Programa 5 Conductas de Servicio Operaciones- Escuela de Servicio").dblclick()
    time.sleep(3)
    ...
    page.locator("#showUserActivityReport").click()
    ...
    page.locator("#report-column-dropdown-container div").filter(has_text="Usuario Borrado").nth(1).click()
    ...
    page.locator("#report-column-dropdown-container div").filter(has_text="Contenidos completados").nth(1).click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "conductas operaciones")
