...
def run(playwright: Playwright) -> None:
    ...
    page.locator("#searchTopbar").click()
    time.sleep(5)
    page.get_by_placeholder("Escribe aquí para buscar...").fill("PIAF")
    page.get_by_role("link", name="Buscar").click()
    page.locator("div").filter(has_text=re.compile(r"^PIAF - Programa de Inducción al Asistente, Aprendiz y Auxiliar de Farmacia$")).click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "PIAF")
