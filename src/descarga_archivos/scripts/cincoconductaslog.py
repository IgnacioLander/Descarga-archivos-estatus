...
def run(playwright: Playwright) -> None:
    ...
    time.sleep(3)
    page.get_by_placeholder("Escribe aquí para buscar...").type("5 conductas", delay=100)
    page.get_by_role("link", name="Buscar").click()
    page.get_by_text("Programa 5 Conductas de Servicio | CENDIS").click()
    page.locator("#courses").click()
    page.get_by_title("Select/Deselect All").locator("span").click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "conductas logistica")
