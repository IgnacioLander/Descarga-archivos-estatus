...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("link", name="Programa Marcas de Cosméticos | Colombia - Escuela Comercial").click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "marcas Co")
