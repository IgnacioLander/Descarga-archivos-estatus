...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_placeholder("Escribe aquí para buscar...").fill("vitaminas y minerales")
    page.get_by_role("link", name="Buscar").click()
    page.locator("div").filter(has_text=re.compile(r"^Programa Vitaminas y Minerales$")).click()
    page.locator("#liveEvent-title").click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "Vitaminas")
