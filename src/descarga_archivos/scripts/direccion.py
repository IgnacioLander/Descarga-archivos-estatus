...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_placeholder("Escribe aquí para buscar...").fill("direcci")
    time.sleep(5)
    ...
    page.get_by_text("Sin filtrosFecha de inscripci").click()
    page.locator("span").filter(has_text="Primer acceso").first.click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "Dirección")
