...
def run(playwright: Playwright) -> None:
    ...
    time.sleep(5)
    page.get_by_placeholder("Escribe aquí para buscar...").fill("SIM MOBILE (MAF)")
    ...
    page.locator("#report-column-dropdown-container div").filter(has_text="Satisfacción").nth(1).click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "SIM(MAF)")
