...
def run(playwright: Playwright) -> None:
    ...
    time.sleep(5)
    page.get_by_placeholder("Escribe aquí para buscar...").fill("Hand")
    page.get_by_role("link", name="Buscar").click()
    page.locator("div").filter(has_text=re.compile(r"^Curso Básico Hand Held$")).click()
    ...
    df = descomprimir_y_leer_excel(zip_file_path, download_path, "Handheld")
